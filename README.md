...
-Add the 1KG project to the database <br>
  ...
  -As we keep using it more data is stored and we will eventually get all (or most) of the data and remove the ensemble API <br>
-Create a frontend for the tables <br>
  ...
  -Maybe a "adv search" feature where we let the user put in the specific populationss themselves <br>
